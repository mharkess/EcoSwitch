    ...
    render() {
      return (
        <React.Fragment>
            ...
            <body style={{background: "rgb(243, 249, 245)", height: 600}}>
            ...
            <div className="page-wrapper" style={{background: "rgb(243, 249, 245)"}}>
                    <div className="page-breadcrumb bg-white">
                        <div className="row align-items-center">
                            <div className="col-lg-3 col-md-4 col-lg-4 col-lg-12">
                                <h4 className="page-title">Assign Student to EcoSwitch Device</h4>
                            </div>
                        </div>
                    </div>
            </div>
